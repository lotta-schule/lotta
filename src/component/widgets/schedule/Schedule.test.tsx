...
describe('component/widgets/Schedule', () => {
    ...
    const mocks = [
        ...
        },
        {
            ...
            result: () => {
                ...
                lastScheduleResponse.schedule.head.date =
        ...
        },
        {
            ...
            result: () => {
                ...
                nextScheduleResponse.schedule.head.date =
    ...
    describe("Pupil's Schedule", () => {
        ...
        it('should show a current schedule', async () => {
            ...
            expect(
                screen.getByRole('row', { name: /1 DE ESn E107/i })
            ).toBeVisible();
            expect(
                screen.getByRole('row', { name: /8 sm15 XMei HDS2/i })
            ).toBeVisible();
            expect(
                screen.getByRole('row', { name: /alles anders/i })
            ).toBeVisible();
            expect(
