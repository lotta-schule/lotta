...
export const UpdatePasswordDialog = memo<UpdatePasswordDialogProps>(({ isOpen, onRequestClose }) => {
    ...
    const [updatePassword, {
        loading: isLoading,
        error
    }] = useMutation<true, { currentPassword: string; newPassword: string; }>(UpdatePasswordMutation, {
    ...
    return (
        <ResponsiveFullScreenDialog open={isOpen} fullWidth>
            <form onSubmit={e => { e.preventDefault(); updatePassword(); }} data-testid="UpdatePasswordDialog">
                <DialogTitle>Passwort ändern</DialogTitle>
                <DialogContent>
                    <DialogContentText>
                        Identifiziere dich mit deinem aktuellen Passwort, wähle dann ein neues Passwort und bestätige es.
                    </DialogContentText>
                ...
                <DialogActions>
                    ...
                    <Button
                        type={'submit'}
                        disabled={!currentPassword || !newPassword || newPassword !== newPasswordRepetition || isLoading}
                        color="secondary"
                        variant="contained"
                    >
                        Passwort ändern
