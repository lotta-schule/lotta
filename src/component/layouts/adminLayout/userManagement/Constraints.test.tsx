...
describe('component/layouts/adminLayout/userManagement/Constraints', () => {
    ...
    it('have the system value prefilled', () => {
        ...
        expect(screen.getByRole('spinbutton', { name: /freier speicher/i })).toHaveValue(20);
    });
    ...
    describe('update the value', () => {
        it('should work by request when changing via input field', async () => {
            ...
            const mocks = [
                {
                    request: { query: UpdateSystemMutation, variables: { system: { userMaxStorageConfig: 20123 } } },
                    result: updateFn
                },
            ];
            const screen = render(
            ...
            userEvent.type(screen.getByRole('spinbutton', { name: /freier speicher/i }), '123');
            userEvent.tab();
            expect(screen.getByRole('spinbutton', { name: /freier speicher/i })).not.toHaveFocus();
