...
export const UnpublishedArticles = memo(() => {
    const {
        data: unpublishedArticlesData,
        loading: isLoading,
        error,
    } = useQuery<{ articles: ArticleModel[] }>(GetUnpublishedArticlesQuery);
    ...
    return (
        <Card>
            <CardContent>
                ...
                {unpublishedArticlesData &&
                    unpublishedArticlesData.articles && (
                        <ArticlesList
                            articles={unpublishedArticlesData.articles}
                        />
                    )}
            </CardContent>
        </Card>
