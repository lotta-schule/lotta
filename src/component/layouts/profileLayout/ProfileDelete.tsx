...
export const ProfileDelete = React.memo(() => {
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <CardContent>
                        ...
                        <Typography
                            className={clsx(styles.paragraph, styles.list)}
                            variant={'body1'}
                            component={'ul'}
                        >
                            <li>
            ...
            <Collapse
                in={!isLoading && currentStep === ProfileDeleteStep.ReviewFiles}
            >
                <Card
                    aria-hidden={
                        isLoading ||
            ...
            >
                ...
                <DialogContent>
                    ...
                    <DialogContentText id={'alert-dialog-description'}>
                        Das Benutzerkonto wird endgültig und unwiederbringlich
                        gelöscht. Daten können nicht wiederhergestellt werden.
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
                    <Button
