...
describe('component/article/module/ContentModule', () => {
    ...
    describe('Text ContentModule', () => {
        ...
        describe('when in edit mode', () => {
            ...
            it('config bar should open a menu when clicking on settings button', async done => {
                const screen = render(
                    <ContentModule
                        isEditModeEnabled
            ...
            it('should call the onRemoveContentModule callback when delete button is clicked', async done => {
    ...
    describe('Title ContentModule', () => {
        ...
        describe('when in edit mode', () => {
            ...
            it('should show the title configuration', async done => {
                const screen = render(
                    <ContentModule
                        isEditModeEnabled
                        cardProps={{ style: { opacity: .8 } }}
    ...
    describe('ImageCollection ContentModule', () => {
        ...
        describe('when in edit mode', () => {
            ...
            it('should show the configuration', async done => {
                const screen = render(
                    <ContentModule
                        isEditModeEnabled
                        cardProps={{ style: { opacity: .8 } }}
