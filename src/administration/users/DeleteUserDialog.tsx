                ...
                <DialogContent>
                    {step === DeleteUserDialogSteps.Start && (
                        <>
                            ...
                            <p>
                                Der Nutzer wird nach erfolgreicher Löschung via
                                Email informiert.
                            </p>
                            <p>
                                Alle Dateien, die dem Nutzer gehören, werden
                                gelöscht.
                            </p>
                        </>
                    )}
                    {step === DeleteUserDialogSteps.Review && (
                        <>
                            ...
                            {articlesWithUseIsLoading && (
                                <CircularProgress
                                    label={
                                        'Beiträge mit Dateien des Nutzers werden ermittelt.'
                                    }
                                />
                            )}
                            {articlesWithUse?.articles.length === 0 && (
                                <p>
                                    Es konnten <strong>keine Dateien</strong>{' '}
                                    von {user.name} in öffentlichen Beiträgen
                                    gefunden werden.
                                </p>
                            )}
                            {Boolean(articlesWithUse?.articles.length) && (
                                <>
                                    <p>
                                        ...
                                        Beiträge gefunden werden, die Dateien
                                        von {user.name} enthalten.
                                    </p>
                                    <p>
                                        Folgende Beiträge enthalten Dateien des
                                        Nutzers:
                                    </p>
                                    <ul>
                                        {articlesWithUse!.articles.map(
                                            (article) => (
                                                <li key={article.id}>
                                                    <Link
                    ...
                    {step === DeleteUserDialogSteps.Confirm && (
                        <>
                            <p>
                                Der Nutzer wird im nächsten Schritt endgültig
                                gelöscht.
                            </p>
                            <p>
