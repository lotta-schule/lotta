            ...
            <Main className={styles.root}>
                ...
                <Box className={styles.box}>
                    ...
                    <p>
                        ...
                        Daten (nachfolgend auch kurz als &quot;Date&quot;
                ...
                <Box className={styles.box}>
                    ...
                    <p>
                        ...
                        Datenschutzgrundverordnung (DSGVO), auf deren Basis wir
                        die personenbezogenen Daten verarbeiten, mit. Bitte
                        beachte, dass zusätzlich zu den Regelungen der DSGVO die
                        nationalen Datenschutzvorgaben in deinem bzw. unserem
                        Wohn- und Sitzland gelten können.
                    </p>
                    <p>
                        <ul>
                            <li>
                                ...
                                - Die betroffene Person hat ihre Einwilligung in
                                die Verarbeitung der sie betreffenden
                                personenbezogenen Daten für einen spezifischen
                ...
                <Box className={styles.box}>
                    ...
                    <p>
                        ...
                        Drittländern mit einem anerkannten Datenschutzniveau, zu
                        denen die unter dem "Privacy-Shield" zertifizierten
                        US-Verarbeiter gehören, oder auf Grundlage besonderer
                        Garantien, wie z.B. vertraglicher Verpflichtung durch
                        sogenannte Standardschutzklauseln der EU-Kommission, des
                        Vorliegens von Zertifizierungen oder verbindlicher
                        interner Datenschutzvorschriften, verarbeiten (Art. 44
                ...
                <Box className={styles.box}>
                    ...
                    <p>
                        ...
                        Geräten der Nutzer gespeichert werden. Mittels Cookies
                        können unterschiedliche Angaben gespeichert werden. Zu
                        den Angaben können z.B. der Loginstatus, oder die
                        Stelle, an der ein Video geschaut wurde, gehören.
                    </p>
                    <p>
                        Cookies werden im Regelfall auch dann eingesetzt, wenn
                        ...
                        Cookies zählen wir ferner andere Technologien, die die
                        gleichen Funktionen wie Cookies erfüllen (z.B., wenn
                        Angaben der Nutzer anhand pseudonymer
                    ...
                    <p>
                        ...
                        Rechtsgrundlage der Verarbeitung Ihrer Daten ist unserer
                        berechtigten Interessen (z.B. betriebswirtschaftlichen
                        Betrieb unseres Onlineangebotes und dessen Verbesserung)
                        oder, wenn der Einsatz von Cookies erforderlich ist, um
                        unsere vertraglichen Verpflichtungen zu erfüllen.
                    </p>
                    <p>
                        <strong>Widerruf und Widerspruch (Opt-Out):</strong> Du
                        hast jederzeit die Möglichkeit, eine erteilte
                        Einwilligung zu widerrufen oder der Verarbeitung Deiner
                        Daten durch Cookie-Technologien zu widersprechen
                        (zusammenfassend als "Opt-Out" bezeichnet).
                        <br />
                        Du kannst deinen Widerspruch zunächst mittels der
                        Einstellungen deines Browsers erklären, z.B., indem Sie
                        die Nutzung von Cookies deaktivierst (wobei hierdurch
                        auch die Funktionsfähigkeit deines Onlineangebotes
                        eingeschränkt werden kann).
                        <br />
                        Für andere Möglichkeiten, schreib uns doch einfach eine
                        Email und wir können mit dir weitere Lösungen
                        besprechen.
                    </p>
                </Box>
                ...
                <Box className={styles.box}>
                    ...
                    <p>
                        ...
                        Änderungen, per E-Mail informiert werden. Wenn Nutzer
                        ihr Nutzerkonto gekündigt haben, werden deren Daten im
                        Hinblick auf das Nutzerkonto, vorbehaltlich einer
                        gesetzlichen Aufbewahrungspflicht, gelöscht. Es obliegt
                        den Nutzern, ihre Daten bei erfolgter Kündigung vor dem
                        Vertragsende zu sichern. Wir sind berechtigt, sämtliche
                        während der Vertragsdauer gespeicherte Daten des Nutzers
                    ...
                    <p>
                        ...
                        besteht hierzu besteht eine gesetzliche Verpflichtung.
                    </p>
                    <div>
                        <ul>
                            <li>
                                ...
                                Inhaltsdaten (z.B. Texteingaben, Fotografien,
                                Videos), Meta-/Kommunikationsdaten (z.B.
                                Geräte-Informationen, IP-Adressen).
                            </li>
                            <li>
                ...
                <Box className={styles.box}>
                    ...
                    <p>
                        ...
                        bereitstellen zu können, nehmen wir die Leistungen von
                        einem oder mehreren Webhosting-Anbietern in Anspruch,
                        von deren Servern (bzw. von ihnen verwalteten Servern)
                        das Onlineangebot abgerufen werden kann. Zu diesen
                    ...
                    <p>
                        ...
                        Hierzu gehören regelmäßig die IP-Adresse, die notwendig
                        ist, um die Inhalte von Onlineangeboten an Browser
                    ...
                    <p>
                        ...
                        Programm-Skripte, mit Hilfe regional verteilter und über
                ...
                <Box className={styles.box}>
                    ...
                    <div>
                        <ul>
                            <li>
                                <strong>Widerspruchsrecht:</strong> Sie haben
                                das Recht, aus Gründen, die sich aus Ihrer
                                besonderen Situation ergeben, jederzeit gegen
                                die Verarbeitung der Sie betreffenden
                                personenbezogenen Daten, die aufgrund von Art. 6
                                Abs. 1 lit. e oder f DSGVO erfolgt, Widerspruch
                                einzulegen; dies gilt auch für ein auf diese
                                Bestimmungen gestütztes Profiling. Werden die
                                ...
                                Profiling, soweit es mit solcher Direktwerbung
                                in Verbindung steht.
                            </li>
                            <li>
                                <strong>
                            ...
                            <li>
                                ...
                                Recht, Sie haben das Recht, eine Bestätigung
                                darüber zu verlangen, ob betreffende Daten
                                verarbeitet werden und auf Auskunft über diese
                                Daten sowie auf weitere Informationen und Kopie
                                der Daten entsprechend den gesetzlichen
                                Vorgaben.
                            </li>
                            <li>
                                <strong>Recht auf Berichtigung:</strong> Sie
                                haben entsprechend den gesetzlichen Vorgaben das
                                Recht, die Vervollständigung der Sie
                                betreffenden Daten oder die Berichtigung der Sie
                            ...
                            <li>
                                ...
                                das Recht, zu verlangen, dass Sie betreffende
                            ...
                            <li>
                                ...
                                Sie haben das Recht, Sie betreffende Daten, die
                                Sie uns bereitgestellt haben, nach Maßgabe der
                                gesetzlichen Vorgaben in einem strukturierten,
                                gängigen und maschinenlesbaren Format zu
                                erhalten oder deren Übermittlung an einen
                            ...
                            <li>
                                ...
                                Vorgaben das Recht, bei einer Aufsichtsbehörde,
                                insbesondere in dem Mitgliedstaat Ihres
                                gewöhnlichen Aufenthaltsorts, Ihres
                ...
                <Box className={styles.box}>
                    ...
                    <ul>
                        <li>
                            <strong>Content Delivery Network (CDN):</strong> Ein
                            "Content Delivery Network" (CDN) ist ein Dienst, mit
                            dessen Hilfe Inhalte eines Onlineangebotes,
                            insbesondere große Mediendateien, wie Grafiken oder
                            Programm-Skripte mit Hilfe regional verteilter und
                            über das Internet verbundener Server, schneller und
                        ...
                        <li>
                            <strong>Verarbeitung:</strong> "Verarbeitung" ist
                            jeder mit oder ohne Hilfe automatisierter Verfahren
                            ausgeführte Vorgang oder jede solche Vorgangsreihe
                            im Zusammenhang mit personenbezogenen Daten. Der
                            Begriff reicht weit und umfasst praktisch jeden
                            Umgang mit Daten, sei es das Erheben, das Auswerten,
