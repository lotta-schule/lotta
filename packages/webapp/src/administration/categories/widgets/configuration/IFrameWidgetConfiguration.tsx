    ...
    ({ configuration, setConfiguration }) => {
      return (
        <div data-testid={'IFrameWidgetConfiguration'}>
          ...
          <p>
            Die URL die im iframe angezeigt werden soll. Dabei ist zu beachten,
            dass Internetseiten es auch verbieten oder beschränken können, in
            einem iframe angezeigt zu werden. Weitere Informationen dazu gibt es
            bei{' '}
            <a
              href={
