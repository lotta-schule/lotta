defmodule Api.ContentTest do
  ...
  describe "articles" do
    ...
    @valid_attrs %{topic: "some topic", preview: "some preview", title: "some title"}
    @update_attrs %{topic: "some updated topic", preview: "some updated preview", title: "some updated title"}
    @invalid_attrs %{topic: nil, preview: nil, title: nil}
