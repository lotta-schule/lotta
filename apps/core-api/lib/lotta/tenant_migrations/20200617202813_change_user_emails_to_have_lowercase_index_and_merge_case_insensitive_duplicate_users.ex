defmodule Lotta.Repo.TenantMigrations.ChangeUserEmailsToHaveLowercaseIndexAndMergeCaseInsensitiveDuplicateUsers do
  @moduledoc false
  ...
  def up do
    ...
    Enum.each(users_grouped, fn users ->
      [keep_user | del_users] =
        users
      ...
      Logger.notice(
        "Es werden dafür die Accounts #{Enum.map_join(del_users, ", ", & &1.email)} entfernt," <>
